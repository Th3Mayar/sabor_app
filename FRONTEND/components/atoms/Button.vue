...
const buttonVariants = {
  variant: {
    ...
    whiteWithOrange:
      "bg-background text-buttonPrimary border border-orange hover:bg-tableActionBg/40 hover:text-white hover:border-background transition-all duration-300 ease-in-out dark:bg-background dark:text-buttonPrimary dark:border-darkOrange dark:hover:bg-tableActionBg/40 dark:hover:text-white dark:hover:border-background",
  },
  size: {
