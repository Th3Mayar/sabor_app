...
export const config = {
  ...
  dbUserLocal: process.env.DB_USER_LOCAL || "",
  dbPasswordLocal: process.env.DB_PASSWORD_LOCAL || "",
  dbHostLocal: process.env.DB_HOST_LOCAL || "",
  dbPortLocal: process.env.DB_PORT_LOCAL
    ? Number(process.env.DB_PORT_LOCAL)
    : 5432,

  // Remote DB configuration
  dbNameRemote: process.env.DB_NAME_REMOTE || "",
